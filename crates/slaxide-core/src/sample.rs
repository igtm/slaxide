...
use crate::{
    AppSettings, AttachmentKind, AttachmentSummary, ChannelPermission, NotificationAction,
    NotificationRule, PatternMatcher, QuietHours, ReactionSummary, ReplyState, SearchProfile,
    SlackConfigSettings, ThemeId, TimelineItem, TimelinePolicy,
};
...
pub fn sample_settings() -> AppSettings {
    AppSettings {
        ...
        office: crate::OfficeSettings::default(),
        shortcuts: crate::ShortcutBindings::default(),
        active_workspace_key: Some("sample-room".into()),
        workspaces: vec![crate::WorkspaceProfile {
            key: "sample-room".into(),
            label: "Sample Workspace".into(),
            team_id: Some("W-dev".into()),
            team_name: Some("Sample Workspace".into()),
            app_id: Some("A-sample".into()),
        }],
        active_search_profile_id: Some("release-focus".into()),
        ...
        search_profiles: vec![SearchProfile {
            ...
            query: Some("ship".into()),
            keyword_profiles: vec![],
            section_profiles: vec![],
            channel_profiles: vec![],
            author_profiles: vec![],
            channels: BTreeSet::from(["C-release".into(), "C-incident".into()]),
            authors: BTreeSet::new(),
        }],
        default_channel_permission: ChannelPermission::ReadWrite,
        channel_permissions: BTreeMap::from([("C-random".into(), ChannelPermission::ReadOnly)]),
    }
}
